...
import { Menu, ShoppingCart, LogOut, CircleDollarSign } from "lucide-react";
...
export default function PageLayout({ children }: { children: ReactNode }) {
    ...
    if (user) {
        ...
        return (
            ...
            <div>
                <div
                    className="h-14 bg-zinc-100 dark:bg-zinc-900 flex justify-end items-center p-2 pr-4 gap-4 border-b-2 border-violet-500"
                >
                    <Sheet>
